...
> Documentation d'ingénierie, étape par étape. Pour une présentation générale du projet
> (fonctionnalités, technologies, démarrage, résultats), voir le **[README](../README.md)**.
